...
const en = {
  ...
  limitations: 'Important limitations', openOfficialService: 'Open the official service', readinessCheck: 'Readiness check', guidedPreparation: 'Prepare with step-by-step guidance',
...
const hi: Messages = {
  ...
  limitations: 'महत्वपूर्ण सीमाएँ', openOfficialService: 'आधिकारिक सेवा खोलें', readinessCheck: 'तैयारी जाँच', guidedPreparation: 'चरण-दर-चरण तैयारी करें',
...
const ml: Messages = {
  ...
  limitations: 'പ്രധാന പരിമിതികൾ', openOfficialService: 'ഔദ്യോഗിക സേവനം തുറക്കുക', readinessCheck: 'തയ്യാറെടുപ്പ് പരിശോധന', guidedPreparation: 'ഘട്ടം ഘട്ടമായി തയ്യാറെടുക്കുക',
