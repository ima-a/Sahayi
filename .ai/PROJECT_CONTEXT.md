...
- One typed bounded LangGraph composes intent confirmation, verified procedure routing, deterministic readiness, optional confirmed document evidence, parallel checklist/synthetic preparation, and official handoff through a strict stateless conversation-turn API. It has no checkpointer, store, database, tracing, or server thread.
