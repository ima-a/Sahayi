...
_COPY = {
    "en": {
        ...
        "watermark": "SYNTHETIC DEMO — NOT AN OFFICIAL APPLICATION — DO NOT SUBMIT",
    ...
    "hi": {
        ...
        "watermark": "कृत्रिम डेमो — आधिकारिक फॉर्म नहीं — जमा करने के लिए नहीं",
    ...
    "ml": {
        ...
        "watermark": "കൃത്രിമ ഡെമോ — ഔദ്യോഗിക ഫോം അല്ല — സമർപ്പിക്കാനുള്ളതല്ല",
